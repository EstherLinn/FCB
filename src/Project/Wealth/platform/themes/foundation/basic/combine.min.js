...
!function(t,e,i){"use strict";var a={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};function s(t,e){var i=a,s="var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('"+t.replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(i.escape,(function(t,e){return"',escapeStr("+e.replace(/\\'/g,"'")+"),'"})).replace(i.interpolate,(function(t,e){return"',"+e.replace(/\\'/g,"'")+",'"})).replace(i.evaluate||null,(function(t,e){return"');"+e.replace(/\\'/g,"'").replace(/[\r\n\t]/g," ")+";__p.push('"})).replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');";let r=new Function("obj",s);return e?r(e):function(t){return r(t)}}var r=function(e,i,a){var s=this;this.opts=a||{},this.cancelBindEvent=this.opts.cancelBindEvent||!1,this.callbacks=this.opts.callbacks||{},this.$container=t(i),this.view=this.opts.view||h,this.criterias=[],this._index=1,this.appendToContainer=this.opts.appendToContainer||l,this.has_pagination=!!this.opts.pagination,this.search_text="",this.anyFilterSelected=!1,this.has_emptyView=!!this.opts.emptyView,this.setTemplate(this.opts.template),t.each(this.opts.criterias||[],(function(){s.addCriteria(this)})),this.Model=JsonQuery(),this.Model.getterFns._fid=function(t){return t._fid},this.addRecords(e,this.opts.filter_on_init||!1),this.has_pagination&&this.initPagination()},n=r.prototype;Object.defineProperty(n,"records",{get:function(){return this.Model.records}}),Object.defineProperty(n,"recordsCount",{get:function(){return this.Model.records.length}}),n.templateBuilder=s,n.execCallback=function(){var t=arguments[0];this.callbacks[t]&&this.callbacks[t].apply(this,Array.prototype.slice.call(arguments,1))},n.addCallback=function(t,e){t&&e&&(this.callbacks[t]=e)},n.addRecords=function(t,e){this.Model.schema;this.execCallback("beforeAddRecords",t);var i=this.Model.addRecords(t);this.emptyView(i),i&&(this.has_scheme||this.initSearch(this.opts.search),this.render(t),!1!==e&&this.filter()),this.execCallback("afterAddRecords",t)},n.reload=function(t){this.Model.records=[],this.addRecords(t)},n.emptyView=function(t){var e=this.opts.emptyView;if(this.has_emptyView){var a=i.querySelector(e.none),s=i.querySelector(e.context);t?(a.style.display="none",s.style.display=""):(a.style.display="",s.style.display="none")}},n.removeRecords=function(e){var i;if(t.isPlainObject(e)?i=this.Model.where(e).pluck("_fid").all:Array.isArray(e)&&(i=this.Model.where({"id.$in":e}).pluck("_fid").all),!i)return!1;for(var a,s=this.Model.records,r=0,n=i.length,h=s.length-1;h>-1&&(a=s[h]._fid,i.indexOf(a)>-1&&(s.splice(h,1),r++,t("#fjs_"+a).remove()),r!==n);h--);return this.execCallback("afterRemove"),!0};var h=function(t,e){return this.templateFn(t)};n.render=function(e){var i=this;e.length&&(this.execCallback("beforeRender",e),"beforeRecordRender",t.each(e,(function(t){i.execCallback("beforeRecordRender",this),this._fid=i._index++,i.has_pagination||i.renderItem(this,t)})))},n.renderItem=function(e,i){if(e){var a=this.view(e,i);"string"==typeof a&&(a=t(t.trim(a))),a.attr("id","fjs_"+e._fid).addClass("fjs_item"),this.appendToContainer(a,e)}};var l=function(t,e){this.$container.append(t)};n.addCriteria=function(e){var i=this;return!!e&&(t.isArray(e)?t.each(e,(function(){o.call(i,this)})):o.call(i,e),!0)};var o=function(e){return!!(e&&e.field&&e.ele)&&(e.ele.indexOf("input:checkbox")>0&&(e.ele=e.ele.replace("input:checkbox","input[type=checkbox]")),e.$ele=t(e.ele),!!e.$ele.length&&(e=function(t){var e=t.$ele,i=t.$ele.attr("type");return t.selector||("INPUT"===e.get(0).tagName?t.selector="checkbox"===i||"radio"===i?":checked":":input":"SELECT"===e.get(0).tagName&&(t.selector="select")),t.event||(t.event="checkbox"===i||"radio"===i||"button"===i?"click":"change"),t}(e),this.bindEvent(e.ele,e.event),e._q=e.field+("range"===e.type?".$bt":""),e.active=!0,this.criterias.push(e),!0))};n.removeCriteria=function(e){var i,a;t.each(this.criterias,(function(t){this.field===e&&(a=t)})),null!==a&&(i=this.criterias.splice(a,1)[0],t("body").off(i.event,i.ele))};var c=function(e,i){var a=this;e&&(Array.isArray(e)||(e=[e]),t.each(e,(function(){var e=this;t.each(a.criterias,(function(){this.field===e&&(this.active=i)}))})))};n.deactivateCriteria=function(t){c.call(self,t,!1)},n.activateCriteria=function(t){c.call(this,t,!0)},n.getSelectedValues=function(e,i){var a=[];return e.$ele.filter(e.selector).each((function(){a.push(t(this).val())})),Array.isArray(a[0])&&(a=[].concat.apply([],a)),!(e.all&&a.indexOf(e.all)>-1)&&("range"===e.type&&(a=a[0].split(e.delimiter||"-")),a=this.parseValues(e.field,a),i.execCallback("onFilterSelect",{criteria:e,values:a})||a)},n.lastResult=function(){return this.last_result||this.records},n.filter=function(){var e,i,a,s={},r=0,n=this;return t.each(this.criterias,(function(){this.active&&(e=n.getSelectedValues(this,n))&&e.length&&(i=Array.isArray(e)&&!this.type?this._q+".$in":this._q,s[i]=e,r+=1)})),this.anyFilterSelected=r>0,a=this.Model.where(s),this.execCallback("shortResult",a),this.last_result=a.all,this.searchFilter(this.last_result)||(this.show(this.last_result),this.renderPagination(this.last_result.length),this.execCallback("afterFilter",this.last_result,JsonQuery.blankClone(this.Model,this.last_result))),s},n.show=function(e,i){var a=0,s=e.length;if(this.has_pagination){if(s=(a=this.page.perPage*(this.page.currentPage-1))+this.page.perPage,this.opts.pagination.headerView){var r=t(this.opts.pagination.headerView).html();this.$container.html(r)}else this.$container.html("");for(;a<s;a++)this.renderItem(e[a],a)}else for(t(".fjs_item").hide();a<s;a++)t("#fjs_"+e[a]._fid).show()},n.filterTimer=function(t){var e=this;this.filterTimeoutId&&clearTimeout(this.filterTimeoutId),this.filterTimeoutId=setTimeout((function(){e.filter()}),t)},n.forceBindEvent=function(e,a){var s=this;t(i).on(a,e,(function(t){s.filterTimer(s.opts.timeout||35)}))},n.bindEvent=function(e,a){var s=this;s.cancelBindEvent||t(i).on(a,e,(function(t){s.filterTimer(s.opts.timeout||35)}))},n.initSearch=function(e){e&&e.ele&&(e.start_length||(this.opts.search.start_length=2),this.$search_ele=t(this.opts.search.ele),this.$search_ele.length&&(this.has_search=!0,this.searchFn=this.buildSearchFn(e.fields),this.bindEvent(e.ele,"keyup")))},n.buildSearchFn=function(e){var i=this,a=[];return e?t.each(e,(function(){a.push(i.Model.getterFns[this])})):t.each(i.Model.getterFns,(function(t,e){a.push(e)})),function(t,e){t=t.toLocaleUpperCase();for(var i=0,s=a.length;i<s;i++)if((a[i](e)+"").toLocaleUpperCase().indexOf(t)>-1)return!0;return!1}},n.lastSearchResult=function(){return this.search_text.length>this.opts.search.start_length?this.search_result:this.lastResult()},n.searchFilter=function(e){if(!this.has_search)return!1;if(this.search_text=t.trim(this.$search_ele.val()),this.search_text.length<this.opts.search.start_length)return!1;var i=this.search(this.search_text,e||this.lastResult());return this.search_result=i,this.show(i),this.renderPagination(i.length),this.execCallback("afterFilter",i,JsonQuery.blankClone(this.Model,i)),!0},n.search=function(t,e){t=t.toLocaleUpperCase();for(var i=[],a=0,s=e.length;a<s;a++)this.searchFn(t,e[a])&&i.push(e[a]);return i},n.setStreaming=function(t){t&&(this.opts.streaming=t,t.data_url&&(t.stream_after=1e3*(t.stream_after||2),t.batch_size=t.batch_size||!1,this.streamData(t.stream_after)))};var u=function(){var e=this,i=this.opts.params||{},a=this.opts.streaming;i.offset=this.recordsCount,a.batch_size&&(i.limit=a.batch_size),this.has_search&&(i.q=t.trim(this.$search_ele.val())),t.getJSON(a.data_url,i).done((function(t){null===i.limit||t&&t.length?(e.setStreamInterval(),e.addRecords(t)):e.stopStreaming()})).fail((function(t){e.stopStreaming()}))};n.setStreamInterval=function(){var t=this;!0!==t.opts.streaming.stop&&(t.streamingTimer=setTimeout((function(){u.call(t)}),t.opts.streaming.stream_after))},n.stopStreaming=function(){this.opts.streaming.stop=!0,this.streamingTimer&&clearTimeout(this.streamingTimer)},n.resumeStreaming=function(){this.opts.streaming.stop=!1,this.streamData(this.opts.streaming.stream_after)},n.streamData=function(t){this.setStreamInterval(),this.opts.streaming.batch_size||this.stopStreaming()},n.clear=function(){this.opts.streaming&&this.stopStreaming(),t.each(this.criterias,(function(){t(i).off(this.event,this.ele)})),this.opts.search&&t(i).off("keyup",this.opts.search.ele),this.filterTimeoutId&&clearTimeout(this.filterTimeoutId)},n.initPagination=function(){var t=this,e=this.opts.pagination;e.perPage||(e.perPage={}),e.perPage.values||(e.perPage.values=[10,20,30]),this.page={currentPage:1,perPage:e.perPage.values},this.paginator=new p(this.lastResult().length,this.opts.pagination,(function(e,i){t.page={currentPage:e,perPage:i},t.has_search?t.show(t.lastSearchResult()):t.show(t.lastResult())})),this.filter()},n.renderPagination=function(t){this.has_pagination&&this.paginator.setRecordCount(t)},n.parseValues=function(e,i){var a=void 0===this.Model.schema?"String":this.Model.schema[e];return"Number"===a?t.map(i,(function(t){return Number(t)})):"Boolean"===a?t.map(i,(function(t){return"true"===t||!0===t})):i},n.setTemplate=function(e,i){this.templateFn=s(t(e).html()),!0===i&&(this.$container.empty(),this.render(this.records),this.filter())};var p=function(e,i,a){var r;this.recordsCount=e,this.opts=i,this.$container=t(this.opts.container),r=this.opts.paginationView?t(this.opts.paginationView).html():v.pagination,this.paginationTmpl=s(r),this.currentPage=1,this.onPagination=a,this.initPerPage(),this.render(),this.bindEvents()},f=p.prototype;function g(t,e){for(var i=t,a=[];i<=e;i++)a.push(i);return a}f.bindEvents=function(){var e=this;t(this.opts.container).on("click","[data-page]",(function(i){e.setCurrentPage(t(this).data("page")),i.preventDefault()}))},f.totalPages=function(){return Math.ceil(this.recordsCount/this.perPageCount)},f.setCurrentPage=function(t){t=this.toPage(t),this.prevCurrentPage=this.currentPage,this.currentPage=t,this.paginate(t),_runpagecheck()},f.setRecordCount=function(t){this.recordsCount=t,this.setCurrentPage(this.currentPage)},f.toPage=function(t){if("first"===t)return 1;if("last"===t)return this.totalPages();if("next"===t){var e=this.currentPage+1;return e>this.totalPages()?this.currentPage:e}if("prev"===t){var i=this.currentPage-1;return i<=0?this.currentPage:i}return parseInt(t)},f.paginate=function(t){this.render(),this.onPagination(this.currentPage,this.perPageCount)},f.render=function(){var t=this.getPages();this.currentPage>t.totalPages&&(this.currentPage=t.totalPages),0===this.currentPage&&(this.currentPage=1),t.currentPage=this.currentPage,this.$container.html(this.paginationTmpl(t))},f.getPages=function(){var t=this.totalPages();if(!this.opts.visiblePages)return{totalPages:t,pages:g(0,t),self:this};var e=Math.floor(this.opts.visiblePages/2),i=this.currentPage-e+1-this.opts.visiblePages%2,a=this.currentPage+e;return i<=0&&(i=1,a=this.opts.visiblePages),a>t&&((i=t-this.opts.visiblePages)<=0&&(i=1),a=t),{currentPage:this.currentPage,totalPages:t,pages:g(i,a),self:this}},f.initPerPage=function(){var e,i,a=this.opts.perPage,r=this;this.perPageCount=a.values[0],e=s(a.perPageView?t(a.perPageView).html():v.per_page)({values:a.values}),t(a.container).html(e),i="SELECT"===t(a.container).find("[data-perpage]").get(0).tagName?"change":"click",t(a.container).on(i,"[data-perpage]",(function(e){var i=parseInt(t(this).val()||t(this).data("value"));r.setPerPage(i),e.preventDefault()}))},f.setPerPage=function(t){this.perPageCount=t,this.setCurrentPage(this.currentPage)},t.fn.filterjs=function(e,i){var a=t(this);a.data("fjs")||a.data("fjs",m(e,a,i))};var d=[],v=[],m=function(t,e,i){var a=new r(t,e,i);return d.push(a),a};function P(e,i){var a="fjs-"+e,s=t("["+a+"]"),r=[];return!!s.length&&(t.each(s,(function(){var e=t(this),i={ele:e},s=e.attr(a);if(r.push(i),!s)return r;t.each(s.split(","),(function(t,e){var a=e.split("=");i[a[0]]=a[1]}))})),i?r:r[0])}m.list=d,m.templateBuilder=s,e.FilterJS=m,v.pagination='<nav>  <ul class="pagination">    <% if(currentPage > 1) { %>      <li> <a href="#" data-page="first" aria-label="First"><span aria-hidden="true">First</span></a> </li>      <li><a href="#" data-page="prev" aria-label="Previous"><span aria-hidden="true">&larr; Previous</span></a></li>    <% } %>    <% for(var i = 0, l = pages.length; i < l; i++ ){ %>      <li class="<%= pages[i] === currentPage ? \'active\' : \'\' %>">        <a href="#" data-page="<%= pages[i] %>"><%= pages[i] %></a>      </li>    <% } %>    <% if( currentPage < totalPages ) { %>      <li><a href="#" data-page="next" aria-label="Next"><span aria-hidden="true">Next &rarr;</span></a></li>      <li><a href="#" data-page="last" aria-label="Last"><span aria-hidden="true">Last</span></a></li>    <% } %>  </ul></nav>',v.per_page='<label for="changepagesforId1" style="display:none">changepages</label><select id="changepagesforId1" size="1" name="per_page" data-perpage="true" class="per-page">  <% for(var i = 0; i < values.length; i++ ){ %>    <option value="<%= values[i] %>"><%= values[i] %></option>  <% } %></select>',m.auto=function(t,e){var i,a,s,r={},n=P("items");if(n&&n.template)return r.template=n.template,(a=P("search"))&&(a.fields&&(a.fields=a.fields.split(",")),r.search=a),e&&(r.callbacks=e),i=m(t,n.ele,r),(s=P("criteria",!0))&&i.addCriteria(s),i}}(jQuery,window,document);
//// lib/way.js/20240101
