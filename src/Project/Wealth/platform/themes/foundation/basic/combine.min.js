//// extensions.js/20240401
!function(t,e){"use strict";if(t.stopBubble||(t.stopBubble=function(t){t&&t.stopPropagation&&t.stopPropagation()}),t.stopDefault||(t.stopDefault=function(t){return t&&t.preventDefault&&t.preventDefault(),!1}),t.addObjectValue||(t.addObjectValue=function(t,e,n){const o=addObjectValue.d||(addObjectValue.d={enumerable:!1,writable:!1,configurable:!1,value:null});o.value=n,Object.defineProperty(t,e,o)}),t.stringRender||(t.stringRender=function(t,e){return t.replace(/\{\{(.*?)\}\}/g,(function(t,n){const o=e[n];return o||0===o?o.toString():(null!==o&&console.warn(t+" is not match of %O",Object.keys(e)),"")}))}),!t.stringFormat){function n(t){return new RegExp("({)?\\{"+t+"\\}(?!})","gm")}t.stringFormat=function(t){let e=t;if(null==e)return"";for(let t=0;t<arguments.length-1;t++){let o=n(t);e=e.replace(o,null==arguments[t+1]?"":arguments[t+1])}return null==(o=e)?"":o.replace(n("\\d+"),"");var o}}t.debounce||(t.debounce=function(t,e){const n=t.delay||e||35;return function(){const e=this;let o=arguments;t._id&&clearTimeout(t._id),t._id=setTimeout((function(){t.apply(e,o),t._id=null}),n)}}),t.throttle||(t.throttle=function(t,e){const n=t.delay||e||35;let o=0;return function(){const e=arguments,r=new Date;if(r-o>n){const n=this;t.apply(n,e),o=r}}}),t.getAllElements||(t.getAllElements=function(t){const n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:e;return Array.prototype.slice.call(n.querySelectorAll(t),0)}),t.extend||(t.extend=function(t){t=t||{};for(let e=1;e<arguments.length;e++)if(arguments[e])for(let n in arguments[e])arguments[e].hasOwnProperty(n)&&(t[n]=arguments[e][n]);return t}),t.getParents||(t.getParents=function(t,n){void 0===n&&(n=e);const o=[];let r=t.parentNode;for(;r!==n;){const t=r;o.push(t),r=t.parentNode}return o.push(n),o})}(window,document);
!function(e,t){"function"==typeof define&&define.amd?define(t):"object"==typeof exports?module.exports=t():e.EventHandler=t(),"loading"!==document.readyState?e.EventHandler.Run():document.addEventListener("DOMContentLoaded",(function(){e.EventHandler.Run()}))}(this,(function(){"use strict";const e=function(){};e.prototype={AddClick:function(e,t){const n=function(e,t){const n=e.delay||t||35;let s=0;return function(){const t=arguments,i=new Date;if(i-s>n){const n=this;e.apply(n,t),s=i}}}(t,1e3);this._addEvent("click",e,n)},AddChange:function(e,t){this._addEvent("change",e,t)},AddExec:function(e,t){this._addEvent("exec",e,t)},AddAction:function(e,t){this._addEvent("action",e,t)},AddMessage:function(e,t){this._addEvent("message",e,t)},_addEvent:function(e,t,n){this._handlerEvents[e][t]||(this._handlerEvents[e][t]=n)},_settings:{selector:"[data-eh]"},_handlerEvents:{click:{},change:{},exec:{},action:{},message:{}},Run:function(){const e=Object.keys(this._handlerEvents);for(let t in e)if(Object.hasOwn(e,t)){const n=e[t],s=this._handlerEvents[n];if(Object.entries(s).length>0)switch(n){case"action":this.ActionHandle(s);break;case"exec":this.ExecHandle(s);break;case"click":case"change":this.OnEventHandle(n,s);break;case"message":this.ListenMessage(s)}}}};const t=new e;return t.OnEventHandle=function(e,t){$(document.body).on(e,this._settings.selector,{handler:t},(function(e){let t=this.getAttribute("data-eh");if(!t)return;let n=t.split(","),s=e.data.handler;for(let t=0,i=n.length;t<i;++t){let i=s[n[t]];i&&i.call(this,e)}}))},t.ExecHandle=function(e){let t=document.querySelectorAll(this._settings.selector);for(let n=0,s=t.length;n<s;++n){let s=t[n],i=s.getAttribute("data-eh");if(!i)continue;let c=i.split(",");for(let t=0,n=c.length;t<n;++t){let n=e[c[t]];n&&n.call(this,s)}}},t.ActionHandle=function(e){const t=Object.keys(e);for(let n in t)Object.hasOwn(t,n)&&e[t[n]]()},t.ListenMessage=function(e){window.addEventListener("message",(function(t){const n=Object.keys(t.data);for(let s in n)if(Object.hasOwn(n,s)){const i=n[s];if(e.hasOwnProperty(i)){const n=t.data[i],s=t.origin;e[i](n,s)}}}),!1)},t}));
