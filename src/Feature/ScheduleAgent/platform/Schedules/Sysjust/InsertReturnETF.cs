    ...
    public class InsertReturnEtf : SitecronAgentBase
    {
        protected override async Task Execute()
        {
            if (this.JobItems != null)
            {
                ...
                var scheduleName = ScheduleName.InsertReturnEtf.ToString();
                ...
                if (IsfilePath.Value)
                {
                    try
                    {
                        ...
                        _repository.BulkInsertToDatabase(datas, tableName + "_History", "FirstBankCode", "NetAssetValueDate", fileName, startTime, scheduleName, threadId);
