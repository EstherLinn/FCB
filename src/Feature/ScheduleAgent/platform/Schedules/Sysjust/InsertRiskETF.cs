    ...
    public class InsertRiskEtf : SitecronAgentBase
    {
        protected override async Task Execute()
        {
            if (this.JobItems != null)
            {
                ...
                string fileName = "SYSJUST-RISK-ETF";
                var TrafficLight = NameofTrafficLight.Sysjust_Risk_ETF;
                var scheduleName = ScheduleName.InsertRiskEtf.ToString();
                ...
                if (IsfilePath.Value)
                {
                    try
                    {
                        ...
                        var datas = await etlService.ParseCsv<SysjustRiskEtf>(fileName);
