...
namespace Feature.Wealth.ScheduleAgent.Schedules.Sysjust
{
    internal class InsertGlobalIndexRoi : SitecronAgentBase
    {
        ...
        {
            string filename = "SYSJUST-GLOBALINDEX_ROI";
            ...
            if (IsfilePath)
            {
                try
                {
                    var basic = await this._etlService.ParseCsv<SysjustGlobalIndexRoi>(filename);
                    _repository.BulkInsertToDatabase(basic, "[Sysjust_GlobalIndex_ROI]", "IndexID", "IndexID", filename);
                }
                catch (Exception ex)
                {
