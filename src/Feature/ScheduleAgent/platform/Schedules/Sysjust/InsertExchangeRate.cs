    ...
    public class InsertExchangeRate : SitecronAgentBase
    {
        protected override async Task Execute()
        {
            if (this.JobItems != null)
            {
                ...
                var scheduleName = ScheduleName.InsertExchangeRate.ToString();
                ...
                if (IsfilePath.Value)
                {
                    try
                    {
                        ...
                        _repository.BulkInsertToDatabase(datas, tableName + "_History", "CurrencyDescription", "CurrencyDescription", fileName, startTime, scheduleName, threadId);
