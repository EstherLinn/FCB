    ...
    public class InsertReturnFund : SitecronAgentBase
    {
        ...
        protected override async Task Execute()
        {
            ...
            if (IsfilePath)
            {
                try
                {
                    var basic = await this._etlService.ParseCsv<SysjustReturnFund>(filename);
                    _repository.BulkInsertDirectToDatabase(basic, "[Sysjust_Return_Fund_History]", filename);
