    ...
    public class InsertRiskFund : SitecronAgentBase
    {
        protected override async Task Execute()
        {
            if (this.JobItems != null)
            {
                ...
                var TrafficLight = NameofTrafficLight.Sysjust_Risk_Fund;
                var scheduleName = ScheduleName.InsertRiskFund.ToString();
                ...
                if (IsfilePath.Value)
                {
                    try
                    {
                        ...
                        var datas = await etlService.ParseCsv<SysjustRiskFund>(fileName);
