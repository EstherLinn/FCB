...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var isEnableCheck = <%= Foundation.Wealth.Models.Config.IsEnableCheck.ToString().ToLower() %>;
        let ssoLogin = new URL(location.protocol + "//" + location.hostname + "/sso/login");
        var queryParams = new URLSearchParams(window.location.search);
        var redirection = queryParams.get('r');

        if (isEnableCheck && redirection !== 'false') {
                ...
                <form id="LoginForm" runat="server" class="form-signin" role="form">
                    ...
                    <div id="passwordRecovery" runat="server" style="display: none">
                        ...
                        <div class="forgot-pass-wrap">
                            <a id="hideRecovery" class="hide-recovery login-link" href="javascript:;" runat="server"><%#Translate.Text(Texts.Back)%></a>
                        </div>
                    </div>
